...
instructions_font = pygame.font.Font("Font/ci-gamedev.ttf", 20)
start_font = pygame.font.Font("Font/ci-gamedev.ttf", 50)
...
ball = moving_object("Ball/White ball.png", screen_rect.centerx, screen_rect.centery)
...
class player:
        ...
        def __init__(self, image, x, y, shield, axis, controls, color_value, plays, wins, loses):
                ...
                self.death_barrier_surf = pygame.transform.scale((pygame.image.load("Barriers/Death.png")), (20, screen_rect.width))
...
### Players
white = player("Players/White.png", 50, screen_rect.centery, "Barriers/White.png", "left", "W/S", "White", 1, 0, 0)
green = player("Players/Green.png", (screen_rect.right - 50), screen_rect.centery, "Barriers/Green.png", "right", "Num 8/Num 2", "Green", 1, 0, 0)
red = player("Players/Red.png", screen_rect.centerx, 50, "Barriers/Red.png", "top", "N/M", "Red", 1, 0, 0)
blue = player("Players/Blue.png", screen_rect.centerx, (screen_rect.bottom - 50), "Barriers/Blue.png", "bottom", "Left/Right", "Blue", 1, 0, 0)
