...
En esa IDE tenes que configurar el ENTORNO VIRTUAL para que sea el de la carpeta "Pong For 4"
Para Visual Studio Code (VSC)
    ...
    Abris la carpeta de "Pong For 4" y desde ahí seleccionas y ejecutas el juego
Si así todo no se entiende, manda un feedback explicando la situación y hacemos un tutorial
